...
@inline function _build_tsit5_caches(::Type{T}) where {T}
    ...
    rs = SVector{22, T}(
        ...
        #=r12=#
        convert(T, 2.9132554618219126),
        #=r13=#
        convert(T, -1.0530884977290216),
        #=r14=#
        convert(T, 0.13169999999999998),
        #=r22=#
        convert(T, -0.2234),
        #=r23=#
        convert(T, 0.1017),
        #=r24=#
        convert(T, 3.9302962368947516),
        #=r32=#
        convert(T, -5.941033872131505),
        #=r33=#
        convert(T, 2.490627285651253),
        #=r34=#
        convert(T, -12.411077166933676),
        #=r42=#
        convert(T, 30.33818863028232),
        #=r43=#
        convert(T, -16.548102889244902),
        #=r44=#
        convert(T, 37.50931341651104),
        #=r52=#
        convert(T, -88.1789048947664),
        #=r53=#
        convert(T, 47.37952196281928),
        #=r54=#
        convert(T, -27.896526289197286),
        #=r62=#
        convert(T, 65.09189467479366),
        #=r63=#
        convert(T, -34.87065786149661),
        #=r64=#
        convert(T, 1.5),
        #=r72=#
        convert(T, -4),
